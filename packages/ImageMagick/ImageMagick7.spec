...
%define im_bin_dir /usr/bin
%define im_include_dir /usr/include
...
%files devel
%defattr(-,root,root,-)
%{im_bin_dir}/MagickCore-config*
%{im_bin_dir}/MagickWand-config*
%{_libdir}/libMagickCore*so*
%{_libdir}/libMagickWand*so*
%{_libdir}/pkgconfig/*.pc
/usr/include/ImageMagick-7/MagickCore/*.h
/usr/include/ImageMagick-7/MagickWand/*.h
